<?php
  session_start(); // ✅ ต้องมีบรรทัดนี้ก่อนใช้งาน $_SESSION
  require '../connect.php';

  if (empty($_SESSION['username'])) {
    header("Location:../login.php");
    exit(); // 🔒 แนะนำให้ใส่ exit หลัง header เพื่อป้องกันโค้ดรันต่อ
  }
?>
            ...
            <li class="nav-item dropdown user-menu">
              <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                <img
                  ...
                  alt="User Image"
                />
                <span class="d-none d-md-inline">Kanyavee Srikanrayanakun</span>
              </a>
              <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                ...
                <li class="user-header text-bg-primary">
                  ...
                  />
                  <p>
                    Kanyavee Srikanrayanakun - Web Developer
                    ...
                    <div class="direct-chat-messages">
                      ...
                      <div class="direct-chat-msg">
                        <div class="direct-chat-infos clearfix">
                          <span class="direct-chat-name float-start"> Kanyavee Srikanrayanakun </span>
